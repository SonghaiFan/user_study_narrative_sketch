  ...
  return (
    <div>
      ...
      >
        ...
        <button
          type="submit"
          className="mt-12 sm:mt-0 font-semibold text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 p-2"
          onClick={onLogout}
        >
          Logout
        </button>
